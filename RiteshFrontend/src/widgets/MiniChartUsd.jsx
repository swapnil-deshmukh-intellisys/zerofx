...
function Usd() {
  ...
  useEffect(() => {
    ...
    script.onerror = () => {
      console.warn('TradingView MiniChartUsd widget failed to load');
    };
  ...
  return (
    <div className="tradingview-widget-container" ref={container} style={{ height: '300px' }}>
      <div className="tradingview-widget-copyright">
        <a href="https://www.tradingview.com/symbols/CMCMARKETS-EURUSD/?exchange=CMCMARKETS" rel="noopener nofollow" target="_blank">
